...
class MainViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, NSFetchedResultsControllerDelegate {
    ...
    func generateTestData() {
        ...
        item.price = 1800.00
        item.details = "Can't wait til the September event.  I want them to release new MBP."
        item.toItemType?.type = "Electronic" 
        
        let item2 = Item(context: context)
        item2.title = "Bose Headphones"
        item2.price = 300.00
        item2.details = "I can't hear anything but within the headphones.  This is sooo cool!"
        item2.toItemType?.type = "Electronic"
        
        let item3 = Item(context: context)
        item3.title = "Tesla Model S"
        item3.price = 110000.00
        item3.details = "Oh man!  This is a beautiful car and one day i will own it."
        item3.toItemType?.type = "Vehicle"
